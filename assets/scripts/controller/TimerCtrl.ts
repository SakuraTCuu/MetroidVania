import { Director, director, log } from "cc";
...
class TimerCtrl {
    ...
    private static instance: TimerCtrl;

    public static getInstance(): TimerCtrl {
        if (!this.instance) {
            this.instance = new TimerCtrl()
        }
    ...
    public async initialize() {
        ...
        this.startTimer(1, () => {
            ...
            if (!this.syncing && this.timeStamp - this.lastSyncTime > TimerCtrl.SYNC_INTERVAL) {
                this.syncTime();
            }
        })
    }
    ...
    */
    ...
    public runNextFrame(func: Function, target?: any) {
        director.once(Director.EVENT_BEFORE_UPDATE, func as any, target);
    }
